...
using Range = NB.Models.Range;

namespace NB.Common
{
    public static class PortHelper
    {
        private static readonly List<Range> TCPReservedRanges = new List<Range>();
        private static readonly List<Range> UDPReservedRanges = new List<Range>();
        ...
        static PortHelper()
        {
            ...
            {
                NBMessageBox.Instance.Show("获取保留端口失败: " + e, "错误");
            }
        }
